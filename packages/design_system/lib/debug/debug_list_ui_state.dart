...
/// 화면에 표시할 데이터를 보유
@freezed
abstract class DebugListPageUiState with _$DebugListPageUiState {
...
@freezed
abstract class DebugListPageAction with _$DebugListPageAction {
  ...
  factory DebugListPageAction.navigateToVoiceChat() = _NavigateToVoiceChat;
}
