...
class SketchTestPageTemplate extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          IconButton(icon: const Icon(Icons.refresh), onPressed: onClear),
        ],
      ),
  ...
  Widget _buildSketchSection(BuildContext context) {
    return Column(
      ...
      children: [
        Text('스케치 이미지', style: Theme.of(context).textTheme.titleMedium),
  ...
  Widget _buildStoryTextSection(BuildContext context) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text('동화 텍스트 (선택사항)', style: Theme.of(context).textTheme.titleMedium),
        const SizedBox(height: 8),
        TextField(
