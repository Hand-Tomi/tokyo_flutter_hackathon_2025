...
다음 정보를 JSON 형식으로 제공해주세요:
{
  ...
  "description": "핵심 분석 내용 (500자 이내)"
}

요구사항:
1. sceneType: 풍경의 종류를 한글로 간결하게 (예: 산, 바다, 도시, 숲, 사막, 호수, 해변 등)
2. tags: 이미지의 핵심 특징을 나타내는 한글 태그 5개 (이미지 생성에 활용됨)
3. description: 이미지의 분위기, 색감, 구도, 시간대, 날씨 등 핵심 내용만 간결하게 (500자 이내)
